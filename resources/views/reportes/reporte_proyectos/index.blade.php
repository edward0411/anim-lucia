@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','REPORTE BASICO PROYECTOS'],
                'title'=>'REPORTE BASICO PROYECTOS',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_proyectos.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="id_departamento" id="id_departamento" class="form-control select2">
                        <option value="">Seleccione departamento</option>
                            @foreach ($departamentos as $departamento)
                                <option value="{{$departamento->codigo_departamento}}">{{$departamento->nombre_departamento}}</option>
                            @endforeach                                       
                      </select>
                    </div>
                </div>
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">REPORTE BASICO PROYECTOS</h3>
                </div>
                <!-- /.card-header -->
