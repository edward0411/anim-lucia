@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte RP movimientos'],
                'title'=>'Reporte RP movimientos',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_rps_movimientos.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">Reporte RP movimientos</h3>
                </div>
                <!-- /.card-header -->
