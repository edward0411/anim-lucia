@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte gestión ambiental fuentes de materiales'],
                'title'=>'Reporte gestión ambiental fuentes',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_gestion_ambiental_fuentes.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">Reporte gestión ambiental fuentes de materiales</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body" style="overflow-x: scroll;max-height: 500px;overflow-y: scroll;">
                    <table id="tabledata" class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th>Municipio</th>
                            <th>Ubicación</th>
                            <th>Permiso minero</th>
                            <th>Permiso ambiental</th>
                            <th>Observaciones</th>
                            <th>Subdireccion</th>
                        </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$busqueda->ubicacion}}</td>
                                <td>{{$busqueda->permiso_minero}}</td>
                                <td>{{$busqueda->permiso_ambiental}}</td>
