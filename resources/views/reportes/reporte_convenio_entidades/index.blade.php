@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte de convenios y entidades'],
                'title'=>'Reporte de convenio y entidades',
                'activeMenu'=>'23'
              ])
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_convenio_entidades.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
                  <div class="col-md-4">
                      <div class="form-group">
                       ...
                       @foreach ($convenio_entidades as $convenio)
           ...
           <div class="card-footer">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Reporte de convenios y entidades</h3>
                </div>
                <!-- /.card-header -->
                        ...
                        <tbody>
                            ...
                            @foreach($search as $busqueda)
                             <tr>
                                 ...
                                 <td>{{number_format((float) $busqueda->valor_convenio, 2, '.', '')}}</td>
