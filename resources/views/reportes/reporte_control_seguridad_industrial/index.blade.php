@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte control de seguridad industrial'],
                'title'=>'Reporte control de seguridad industrial',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_control_seguridad_industrial.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">Reporte control de seguridad industrial</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body" style="overflow-x: scroll;max-height: 500px;overflow-y: scroll;">
                    <table id="tabledata" class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th>Accidente laboral o incidente</th>
                            <th>Tipo</th>
                            <th>Fecha</th>
                            <th>Plan de mejora o lección aprendida</th>
                            <th>Adoptado</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$busqueda->accidente_laboral_incidente}}</td>
                                <td>{{$busqueda->param_tipo_accidente_texto}}</td>
                                <td>{{$busqueda->fecha}}</td>
                                <td>{{$busqueda->plan_mejora_leccion_aprendida}}</td>
                                <td>{{$busqueda->adoptado}}</td>
