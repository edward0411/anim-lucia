@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte de proyectos personas asignadas'],
                'title'=>'Reporte de personas asignadas',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_personas_asignadas_proyectos.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">Reporte de Personas Asignadas</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="tabledata" class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$busqueda->name}}</td>
                                <td>{{$busqueda->param_tipo_rol_texto}}</td>
