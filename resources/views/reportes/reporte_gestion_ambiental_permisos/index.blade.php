@extends('layouts.app',
        $vars=[ 'breadcrum' => ['Reportes','Reporte gestión ambiental - Permisos ambientales'],
                'title'=>'Reporte gestión ambiental - Permisos ambientales',
                'activeMenu'=>'23'
              ])
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" method="POST"  action="{{route('reportes.reporte_gestion_ambiental_permisos.busqueda')}}">
                    @csrf
                    @method('POST')
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card card-primary  shadow">
                <div class="card-header">
                    <h3 class="card-title">Reporte gestión ambiental - Permisos ambientales</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="tabledata" class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$busqueda->param_tipo_permiso_text}}</td>
                                <td>{{$busqueda->documento_soporte}}</td>
                                <td>{{$busqueda->seguimiento}}</td>
