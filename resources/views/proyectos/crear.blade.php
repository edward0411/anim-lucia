...
<div class="row">
    <div class="col-12">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="proyecto_principal" id="proyecto_principal" >
                                    ...
                                    @foreach($proyecto_pal as $proyecto)
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipo_proyecto" class="form-control" id="tipo_proyecto" required>
                                    ...
                                    <option value="{{$tipo->valor}}"
                                        {{(old('tipo_proyecto') ?? $proyectos->param_tipo_proyecto_valor  ?? 0 ) == $tipo->valor ? "selected" :""  }}>
                                        {{$tipo->texto}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="objeto_proyecto" id="objeto_proyecto" class="form-control"
                                placeholder="Digitar la descripción del proyecto o fase que se va a digitar" required>{{old('objeto_proyecto') }}</textarea>
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Departamento *</label>
                                 <select name="departamento" class="form-control" id="departamento"
                                    ...
                                    {{(old('departamento') ??   0 ) == $departamento->id ? "selected" :""  }}
                            ...
                            <div class="form-group">
                                <label>Municipio *</label>
                                 <select name="id_municipio" class="form-control" id="id_municipio"
                                    ...
                                    @foreach($municipios as $municipioDepto)
                                        <option value="{{$municipioDepto->id}}"

                                            {{ (old('id_municipio') ??  0 ) ==$municipioDepto->id ? "selected":"" }} >
                            ...
                            <div class="form-group">
                                <label>Direccion *</label>
                                 <input type="text" name="direccion" class="form-control" id="direccion"
                                    placeholder="" required value ="{{old('direccion') }}">
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label>Latitud *</label>
                                <input  type="number" step=".000001" name="latitud" id="latitud" class="form-control" maxlebgth="20"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="number" step=".000001" name="longitud" id="longitud" class="form-control" max="0" maxlebgth="20"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="number" step=".000001" name="altitud" id="altitud" class="form-control" min="0.01" maxlebgth="20"
                                value ="{{old('altitud') }}" required>
        ...
        <div class="card-footer">
            ...
            <input type="hidden" name="id_proyecto_crear" id="id_proyecto_crear" value="1">
            <div class="form-row">
                        <div class="col-md-4">
