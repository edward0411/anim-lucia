...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-primary shadow">
                     ...
                     <div class="col-md-6 ">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="DivPlanMejora">
                                ...
                                <textarea name="plan_mejora" id="plan_mejora" class="form-control" maxlength="2500" ></textarea>
                            </div>
                        </div>
                            <div class="col-md-6">
         ...
         <div class="card card-primary shadow">
             <div class="card-header">
                <h3 class="card-title">Control de Seguridad Industrial / Actividades Realizadas</h3>
            </div>
          @can('modulo_tecnico.informe_seguimiento.calidad_seguridad.crear')
            <form role="form" enctype="multipart/form-data" method="POST" action="{{ route('gestion_calidad_seguridad.ActividadesRealizadas.store')}}" id="frmActividadesRealizadas">
                 @csrf
                 <div class="card-body">
                    <div class="form-row">
                        <div class="col-md-6">
