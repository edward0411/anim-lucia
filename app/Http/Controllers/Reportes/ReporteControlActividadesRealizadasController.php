...
class ReporteControlActividadesRealizadasController extends Controller
{
    public function index(){

        $proyectos = DB::table('calidad_seguridad_industriales')
        ->Join('calidad_seguridad_industrial_actividades_realizadas','calidad_seguridad_industrial_actividades_realizadas.id_calidad_seguridad_industrial','=','calidad_seguridad_industriales.id')
        ...
        return view('reportes.reporte_control_actividades_realizadas.index',compact('proyectos','search'));
    }

    public function busqueda_control_actividades_realizadas(Request $request){
        ...
        if (($request->fecha_hasta != null) && ($request->fecha_desde != null)) {
            ...
            if ($request->fecha_hasta < $request->fecha_desde) {
                ...
                return redirect()->route('reportes.reporte_control_actividades_realizadas.index')->with('error','Por favor validar que la fecha hasta no sea inferior a la fecha desde')->withInput($request->input());
             }
          }
          ...
          ->select('calidad_seguridad_industriales.id','proyectos.nombre_proyecto','users.name','contratos.numero_contrato','calidad_seguridad_industriales.fecha_informe',
                  'calidad_seguridad_industrial_actividades_realizadas.de_medida_preventiva','calidad_seguridad_industrial_actividades_realizadas.actividades_higiene_seguridad_industrial');
       ...
       return view('reportes.reporte_control_actividades_realizadas.index',compact('search','olddata','proyectos','active'));
    }
}
